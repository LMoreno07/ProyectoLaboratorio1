...
from app.api.v1.endpoints import roles, usuarios, auth, maquinas, ventas, productos,planes,categorias_maquinas, reservas, clientes, pagos, entrenadores, membresias
    #acceso,
    #finanzas,
    #tienda,
    #biometrico
